...
if($_REQUEST['email3'])
{
$sql=mysql_fetch_array(mysql_query("select * from tbl_parent where mobile='".$_REQUEST['email3']."'"));
if(!$sql)
	{
?>
<script language="javascript">
location.href="parent_forgot_pass.php?opt=3";
</script>
<?php
}
else
{
$member_data=mysql_fetch_array(mysql_query("select * from tbl_parent where 1 and mobile='".$_REQUEST['email3']."'"));
$to=$member_data['email'];
$subject="Forgot Password of Payurfess - user";
$message = "
<html>
<head>
...
<script language="javascript">
		...
		location.href="parent_forgot_pass.php?opt=4";
