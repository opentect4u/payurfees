...
pmode='".addslashes($_REQUEST['pmode'])."',
pfre='".addslashes($_REQUEST['pfre'])."',
...
pmode='".addslashes($_REQUEST['pmode1'])."',
pfre='".addslashes($_REQUEST['pfre1'])."',
details='".addslashes($_REQUEST['details1'])."',
fee_type='".addslashes($_REQUEST['fee_type1'])."',
amount='".addslashes($_REQUEST['amount1'])."',
start_date='".addslashes($_REQUEST['start_date1'])."',
end_date='".addslashes($_REQUEST['end_date1'])."',
due_date='".$_REQUEST['year1']."-".$_REQUEST['month1']."-".$_REQUEST['day1']."',
doj='".date("Y-m-d")."'";
mysql_query($sql1);
}
...
pmode='".addslashes($_REQUEST['pmode2'])."',
pfre='".addslashes($_REQUEST['pfre2'])."',
details='".addslashes($_REQUEST['details2'])."',
fee_type='".addslashes($_REQUEST['fee_type2'])."',
amount='".addslashes($_REQUEST['amount2'])."',
start_date='".addslashes($_REQUEST['start_date2'])."',
end_date='".addslashes($_REQUEST['end_date2'])."',
due_date='".$_REQUEST['year2']."-".$_REQUEST['month2']."-".$_REQUEST['day2']."',
doj='".date("Y-m-d")."'";
mysql_query($sql2);
}
...
<td  width="70%" align="center" valign="top"><h2>Add Fee Structure </h2>
