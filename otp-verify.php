...
$data=mysql_fetch_array(mysql_query("select * from tbl_institute where  id='".$u_id."'"));
?>
<?php
if($_REQUEST['otp_code'])
 {
  $sql = "select * from tbl_institute where otp_code = '".$_REQUEST['otp_code']."' and id='".$u_id."' ";
...
{
$sql2 = "update  tbl_institute set  otp_status='1'  where otp_code = '".$_REQUEST['otp_code']."' and id='".$u_id."' ";
mysql_query($sql2);
//$msg=1;
...
$to = $data['email'];
$subject = "Registration Notification from Payurfees - Institute";
$message = "
<html>
<head>
...
<p>
Your institute ".$data['ins_name']." has been successfully registered with us,with user id ".$data['mobile']." For Activation our
...
location.href="ins_log.php?opt=3";
</script>
<?php
}
