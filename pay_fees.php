...
<form name="aa" action="pay_fees_step2.php" method="post" enctype="multipart/form-data" class="form-horizontal row-fluid">
<div class="control-group">

											<label class="control-label" for="basicinput"><strong>Student  Name <font color=red>*</font>:</strong></label>

											<div class="controls">
                                            
                                            <?php //echo $s6="select * from tbl_student where 1 and pid='".$_SESSION['parent_id']."' order by id asc "; ?>
                                            
                                            <select name="student_id" id="student_id" onChange="showUser(this.value)"/>
                                            <option value="">--Select--</option>

<?php
$s6="select * from tbl_student where 1 and pid='".$_SESSION['parent_id']."' order by id asc ";
$r6=mysql_query($s6);
while($d6=mysql_fetch_array($r6))
{
?>
<option value="<?php echo $d6['id'];?>"><?php echo $d6['ins_name'];?><?php echo $d6['student_name'];?></option>
