...
$params['order_id'] = 'ORD-'.date(YmdHis);
if($_REQUEST['amt'])
{
...
$params['udf1'] = $_REQUEST['info_period'];
$params['udf2'] =$_REQUEST['student_id']."_".$_REQUEST['roll_no']."_".$_REQUEST['section_name']. "_".$_REQUEST['course'];
$params['udf3'] = $_REQUEST['ins_id']."_".$_REQUEST['late_fee'];
