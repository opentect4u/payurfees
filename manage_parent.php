...
<td  width="70%" align="center" valign="top"><h2>Manage Parent</h2>
...
<?php
$s="select * from tbl_parent where 1 and ins_id='".$_SESSION['ins_id']."' order by id desc";
   $r=mysql_query($s);
   $n=mysql_num_rows($r);
   if($n>0)
   {
   ...
   <td align="center">
   <?php echo $d['mobile'];?></td>
   <td align="center"><?php echo $d['password'];?></td>
  
   <td align="center">
   
   <?php $dt=explode("-",$d['doj']); echo $dt[2]."/".$dt[1]."/".$dt[0];?></td>
