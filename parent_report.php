                    ...
                    <div class="span9">
						...
						<div class="module">
							...
							<div class="module-head" style="background:#042139">
								...
								<h2 style="color:#ffffff">Parent Report</h2>
...
<b>From Date: </b> <input type="text" name="firstinput" id='firstinput' size=20> <small><a href="javascript:showCal('Calendar1')">Select</a></small>
<b>To Date: </b> <input type="text" name="secondinput" id='secondinput' size=20> <small><a href="javascript:showCal('Calendar2')">Select</a></small>
<select name='ins_id'>
<option value="">-- select Institute---</option>
<?php
$spi="select * from tbl_institute where 1 and status='1' order by ins_name";
$rpi=mysql_query($spi);
...
if($_REQUEST['ins_id'])
{
 $s="select * from tbl_collect_fees where 1 and ins_id='".$_REQUEST['ins_id']."' and pid='".$_SESSION['parent_id']."' and payment_date>='".$_REQUEST['firstinput']."' and payment_date<='".$_REQUEST['secondinput']."' and pid>'0' order by id desc";

}
else
{
 $s="select * from tbl_collect_fees where 1 and pid='".$_SESSION['parent_id']."' and payment_date>='".$_REQUEST['firstinput']."' and payment_date<='".$_REQUEST['secondinput']."' and pid>'0' order by id desc";
 }
