                    ...
                    <div class="span9">
						...
						<div class="module">
							...
							<div class="module-head" style="background:#042139">
								...
								<h2 style="color:#ffffff">Collect Fees</h2>

							</div>

							<div class="module-body">

<form name="aa" action="search_children.php" method="post" enctype="multipart/form-data" class="form-horizontal row-fluid">
...
<?php
$s6="select * from tbl_institute where 1 and status='1' and id='".$_SESSION['ins_id']."'order by ins_name asc ";
$r6=mysql_query($s6);
