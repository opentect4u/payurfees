...
<form name="aa" action="pay_fees_step4.php" method="post" enctype="multipart/form-data" class="form-horizontal row-fluid">
...
foreach($_REQUEST['chk'] as $reg)
   ...
   $mon1="12";
		...
		?></td>
        <td align="right"><?php  $ab+=$dt[2]+$latefe;  if($latefe>0) { echo $dt[2];?>+<?php echo $latefe; echo "="; echo $dt[2]+$latefe; } else { echo $dt[2]; }?></td>
		</tr>
		<?php
		$cn++;
	}	
...
<input type="hidden" name="tot_amt" value="<?php echo $ab+$ab2;?>"/>
