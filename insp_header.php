                    ...
                    <div class="nav-collapse collapse navbar-inverse-collapse">
                       ...
                       <!-- <ul class="nav nav-icons">
                        ...
                        <ul class="nav pull-right">
                            ...
                            <li><a href="#"><span style="color:#042139; font-size:150%;" class="blink"><?php echo $mem_data['name'];?></span>  </a></li>
...
<div class="wrapper" style="padding-top: 8px; padding-bottom: 8px">
		<div class="container">
			<div class="row" >
           <div class="span12">
           <!--<a href="index.php" style="color:#0060b3; font-weight:bold; font-size:16px;">Home</a>&nbsp;|&nbsp;<a href="#" style="color:#042139; font-weight:bold; font-size:16px;">About Us</a>&nbsp;|&nbsp;<a href="#" style="color:#042139; font-weight:bold; font-size:16px;">Contact Us</a> &nbsp;|&nbsp;--><a href="index.php" style="color:#042139; font-weight:bold; font-size:16px;">Home</a>&nbsp;|&nbsp;<a href="my_dashboard.php" style="color:#042139; font-weight:bold; font-size:16px;">My Profile</a>&nbsp;|&nbsp;<a href="#" style="color:#042139; font-weight:bold; font-size:16px;">Demo</a>&nbsp;|&nbsp;<a href="plogout.php" style="color:#042139; font-weight:bold; font-size:16px;">Logout</a>
          </div> 
           </div>
            </div>
            </div>
