...
<div class="control-group">
											...
											<div class="controls"><select  name="class_name" id="class_name" class="span8 tip">
                                                <option value="">--select--</option>
...
<div class="control-group">
											...
											<div class="controls"><select  name="year_reg" id="year_reg"/>
<option value="">--select--</option>
...
<div class="control-group">
											...
											<div class="controls"><input type="text" name="reg_no" id="reg_no"/></div>
</div>
<div>&nbsp;</div>
