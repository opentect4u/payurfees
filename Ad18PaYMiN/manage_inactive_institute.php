...
$mode="  and status='0' $name $mobile order by id desc";
...
if($_REQUEST['mode']=='del')
{
	...
	?>
	<meta http-equiv="refresh" content="0; url=manage_inactive_institute.php" />
	<?php
} 
?>
...
function go_there(id)
{
	...
	if (where_to== true)
	{
		window.location="manage_inactive_institute.php?id="+id+"&mode=del";
	}
}
</SCRIPT>
...
//alert("aaa");
	...
	if(str>0)
	{
		window.location="manage_inactive_institute.php?cid="+str;
		}
		else
		{
		window.location="manage_inactive_institute.php";
		}
...
<table width="0%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td align="left" valign="middle" class="select_txt">List of In-Active  Institute(s)</td>
  </tr>
</table></div>
<!--<p>&nbsp;</p>-->
	<center>
...
<table width="99%" border="0" cellspacing="0" cellpadding="0">
  <tr>
   ...
   <tr>
    <td  height="27" align="left" valign="middle" class="menubg"><form name="" action="manage_inactive_institute.php" method="post">
  ...
  <tr>
    <td  height="27" align="left" valign="middle" class="menubg"><span class="showtxt"><strong>In-Active Institute List</strong></span> </td>
  </tr>
...
{  	
  ...
  <tr class="<?php echo $alt;?>">
    ...
    <td align="center" valign="middle"><b><?php echo ucwords($row[$m]['ins_name']); ?></b><br/><?php echo ucwords($row[$m]['ins_type']); ?><br/> <?php if($row[$m]['en_month']) { echo ($row[$m]['st_month'])."-".$row[$m]['st_year']; ?> to <?php echo ($row[$m]['en_month'])."-".$row[$m]['en_year']; } ?></td>
...
if(count($row)>0)
  ...
  ?>Page: <?php 
	  ...
	  $ob=new Paginate2;
	  $page= $ob->paginate1($table_name,$selected_field,$file_name,$page,$limit,"  and status='0' $name $mobile order by id asc");
	  echo $page;
	}
	?></td>
  </tr>
