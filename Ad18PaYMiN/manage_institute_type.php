...
$mode="  $cid order by id asc";
$row=$qr->select_row($table_name,$selected_field,$mode,$start,$total);

if($_REQUEST['del'])
{
	$qr->delete("tbl_institute_type","id",$_GET['id']);
		
	?>
	<meta http-equiv="refresh" content="0; url=manage_institute_type.php" />
	<?php
} 
?>
...
{
	var where_to= confirm("Do you really want to delete this Type?");
	if (where_to== true)
	{
		window.location="manage_institute_type.php.php?id="+id+"&del";
	}
}
</SCRIPT>
...
//alert("aaa");
	...
	if(str>0)
	{
		window.location="manage_institute_type.php?cid="+str;
		}
		else
		{
		window.location="manage_institute_type.php";
		}
...
<table width="0%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td align="left" valign="middle" class="brown_text_big">Intitute Type Management </td>
	<td align="left" valign="middle"><img src="images/icon.gif" alt="TMC" /></td>
    <td align="left" valign="middle" class="select_txt">Show Institute Type</td>
  </tr>
</table></div>
<!--<p>&nbsp;</p>-->
	<center>
...
<table width="99%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td  height="27" align="left" valign="middle" class="menubg"><span class="showtxt"><strong>All Intitute Type List</strong></span> </td>
  </tr>
  ...
  <tr>
    ...
    <td width="30%" align="center" valign="middle" bgcolor="#20789C" class="white_txt">Institute Type </td>
    <!-- <td width="40%" align="center" valign="middle" bgcolor="#20789C" class="white_txt">Sub-Course Accessibility </td>-->
...
{  	
  ...
  <tr class="<?php echo $alt;?>">
    ...
    <td align="center" valign="middle"><?php echo ucwords($row[$m]['institute_type']); ?>
	</td>
  <!-- <td align="center" valign="middle"><?php if($row[$m]['status']=='2'){ ?><b style="color:#006600">Yes</b><?php } else {?><b style="color:#FF0000">No <?php }?>
	</td>-->
    <td align="center" valign="middle">N/A<!--<a href="edit_institute_type.php?id=<?php echo $row[$m]['id']; ?>&edit"><img src="images/b_edit.png" alt="edit" border="0"></a>--></td>
    <td align="center" valign="middle">N/A <!--<a href="#" onClick="go_there(<?php echo $row[$m]['id']; ?>)";><img src="images/b_drop.png" alt="Delete" border="0"></a>--></td>
...
if(count($row)>0)
  ...
  ?>Page: <?php 
	  ...
	  $ob=new Paginate2;
	  $page= $ob->paginate1($table_name,$selected_field,$file_name,$page,$limit," order by id asc");
	  echo $page;
	}
	?></td>
  </tr>
