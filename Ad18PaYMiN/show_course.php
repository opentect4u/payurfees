...
$mode="  and pid='0' order by institute_type_id,id  asc";
...
if($_REQUEST['mode']=='del')
{
	...
	?>
	<meta http-equiv="refresh" content="0; url=show_course.php" />
	<?php
} 
?>
...
function go_there(id)
{
	...
	if (where_to== true)
	{
		window.location="show_course.php.php?id="+id+"&mode=del";
	}
}
</SCRIPT>
...
//alert("aaa");
	...
	if(str>0)
	{
		window.location="show_course.php?cid="+str;
		}
		else
		{
		window.location="show_course.php";
		}
...
<table width="0%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td align="left" valign="middle" class="select_txt">Show Course</td>
  </tr>
</table></div>
<!--<p>&nbsp;</p>-->
	<center>
...
<table width="99%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td  height="27" align="left" valign="middle" class="menubg"><span class="showtxt"><strong>All Course List</strong></span> </td>
  </tr>
  ...
  <tr>
    ...
    <td width="30%" align="center" valign="middle" bgcolor="#20789C" class="white_txt">Institute Type </td>
     <td width="40%" align="center" valign="middle" bgcolor="#20789C" class="white_txt">Course/Class </td>
...
{  	
  ...
  <tr class="<?php echo $alt;?>">
    ...
    <td align="center" valign="middle"><?php $it=mysql_fetch_array(mysql_query("select * from tbl_institute_type where 1 and id='".($row[$m]['institute_type_id'])."' ")); ?><b><?php echo $it['institute_type'] ?></b>
	</td>
   <td align="center" valign="middle"><?php echo ucwords($row[$m]['course_name']); ?>
	</td>
    <td align="center" valign="middle"><a href="edit_course.php?id=<?php echo $row[$m]['id']; ?>&edit"><img src="images/b_edit.png" alt="edit" border="0"></a></td>
