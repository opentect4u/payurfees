...
if($_REQUEST['cat_name'])
{
	...
	?>
	 <script type="text/javascript">
		location.href="edit_subcourse.php?opt=1&id=<?php echo $_GET['id'];?>";
		</script>
	<?php
...
if(category_name=='')
{
alert("Please enter the  SubCourse name");
...
<table width="0%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td align="left" valign="middle" class="select_txt">Edit Sub-Course Name</td>
  </tr>
</table></div>
<!--<p>&nbsp;</p>-->
	<center>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
		  <tr>
			...
			?>
				...
				<td align="left" valign="middle"><label> <select name="institute_type_id" id="institute_type_id" disabled="disabled"><option value="" <?php if($data['institute_type_id']=="") { echo "selected"; }?>>--None--</option>
				<?php
              ...
              <tr>
				...
				<?php
				$s="select * from tbl_course where 1  and pid='0' and institute_type_id='".$data['institute_type_id']."' order by id asc";
				$r=mysql_query($s);
				while($d=mysql_fetch_array($r))
				{
				?>
				<option value="<?php echo $d['id'];?>" <?php if($data['pid']==$d['id']) { echo "selected"; }?>><?php echo $d['course_name'];?></option>
				<?php
				}
				?></select> </div></td>
			  </tr>
