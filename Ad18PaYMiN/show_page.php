...
if($_REQUEST['del'])
{
	$qr->delete("page","id",$_GET['id']);
		
	?>
	<meta http-equiv="refresh" content="0; url=show_page.php" />
	<?php
} 
?>
...
{
	var where_to= confirm("Do you really want to delete this page?");
	if (where_to== true)
	{
		window.location="show_page.php?id="+id+"&del";
	}
}
</SCRIPT>
...
//alert("aaa");
	...
	if(str>0)
	{
		window.location="show_page.php?cid="+str;
		}
		else
		{
		window.location="show_page.php";
		}
...
<table width="0%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td align="left" valign="middle" class="select_txt">Show Page</td>
  </tr>
</table></div>
<!--<p>&nbsp;</p>-->
	<center>
...
<table width="99%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td  height="27" align="left" valign="middle" class="menubg"><span class="showtxt"><strong>All Page List</strong></span> </td>
  </tr>
  ...
  <tr>
    ...
    <td width="20%" align="center" valign="middle" bgcolor="#20789C" class="white_txt">Page Name </td>
     <td width="20%" align="center" valign="middle" bgcolor="#20789C" class="white_txt">Page Parent </td>
...
{  	
  ...
  <tr class="<?php echo $alt;?>">
    ...
    <td align="center" valign="middle"><?php echo ucwords($row[$m]['name']); ?>
	</td>
  <td align="center" valign="middle">
  <?php 
  $pg=mysql_fetch_array(mysql_query("select * from page where 1 and id='".$row[$m]['pid']."'")); 
  if($row[$m]['pid']=="0")
  {
  echo "<b style=color:green;>Root</b>";
  }
  else
  {
  echo "<b>".stripslashes($pg['name'])."</b>";
  }
  ?></td>
    <td align="center" valign="middle"><a href="edit_page.php?id=<?php echo $row[$m]['id']; ?>&edit"><img src="images/b_edit.png" alt="edit" border="0"></a></td>
